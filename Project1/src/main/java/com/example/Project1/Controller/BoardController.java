...
public class BoardController {
    ...
    @GetMapping("/write")
    public String write_page(@ModelAttribute HttpSession httpSession) {
        //유저 확인하고 권한 줘야함
        ...
        //UserEntity에서 findbyemail사용해서 유저 정보를 찾습니다.
    ...
    //그렇지 않다면 다시 되돌아 갑니다.
    @GetMapping("/modify")
    public String modify_go(@ModelAttribute HttpSession httpSession) {

    }
    
    @PostMapping("modify")
    public String modify_do(/*Parameter parameter */);
    ...
    @GetMapping("/delete")
    public String delete_go(/*Parameter parameter */);

    @PostMapping("/delete")
    public String delete_do(/*Parameter parameter */);


    //조회수를 증가시키는 api입니다.
    //글로 들어갈 때 마다 조회수가 하나씩 증가되고, 이는 기존 디비에서 반영이 됩니다.
    //주소명은 api/board/유저명+게시글의 id 이렇게 하겠습니다.
    @GetMapping(value="/{}")
